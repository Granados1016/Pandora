  ...
  apps: [
    ...
    // ── Backend — ASP.NET Core 8 ───────────────────────────────────────────
    {
      ...
      env: {
        ...
        Jwt__Key:                            'ZXYJxrFSdwu9YVxB-WAR7UVjXhmV5IRTCuZbHKinlqga6WBbclWXeOspYdrkDURU',
        Jwt__Issuer:                         'PandoraAPI',
        Jwt__Audience:                       'PandoraClient',
        Jwt__ExpiresInMinutes:               '30',
        JwtSettings__Key:                    'ZXYJxrFSdwu9YVxB-WAR7UVjXhmV5IRTCuZbHKinlqga6WBbclWXeOspYdrkDURU',
